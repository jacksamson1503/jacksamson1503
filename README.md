...
**[CI/CD Pipeline (Jenkins + AWS)](https://github.com/jacksamson1503/CI-CD-Login-Portal-with-Jenkins-on-AWS)**
Automated build-test-deploy pipeline for a login portal, using Jenkins to orchestrate deployment to AWS.

**[Prometheus & Grafana Monitoring on AWS EC2](https://github.com/jacksamson1503/Prometheus-Grafana-Monitoring-on-AWS-EC2)**
End-to-end monitoring stack on EC2 with Prometheus for metrics collection and Grafana dashboards for visualization.

**[AWS Auto Scaling](https://github.com/jacksamson1503/AWS_Auto-Scaling)**
Auto Scaling Group setup that dynamically adjusts EC2 capacity based on load.

**[AWS Load Balancer](https://github.com/jacksamson1503/Jack_AWS_Loadbalancer)**
Application Load Balancer configuration for distributing traffic across multiple EC2 instances.

**[Terraform Static Website (S3)](https://github.com/jacksamson1503/terraform-aws-s3-static-website)**
Infrastructure-as-code deployment of a static site to S3, fully provisioned with Terraform.

**[Jenkins CI/CD Pipeline](https://github.com/jacksamson1503/Jenkins-CI-CD)**
General-purpose Jenkins pipeline template for continuous integration and delivery workflows.
